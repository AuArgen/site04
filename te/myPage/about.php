...
<body>
    ...
    <div class="container homeContainer">
        <form action="" method="post" class="form-control" enctype="multipart/form-data">
            <div class="form-control btn btn-success" id="slide"><h2 class = "fas fa-sliders"> Маалымат кошуу</h2> </div>
            <div class="p-5 text-center">
                <input type="text" name="theme" id="theme" class="form-control" placeholder = "Введите Ф.И.О. ..." required>
                <br>
                <textarea name="text" id="text" cols="30" rows="5" class="form-control" placeholder = "Введите о вас..." required></textarea>
                <br>
                <input type="text" name="tel" id="tel" class="form-control" placeholder = "Введите телефон номер. ..." required>
                <input type="text" name="whatsapp" id="whatsapp" class="form-control" placeholder = "Введите whatsapp номер. ..." required>
                <input type="text" name="email" id="email" class="form-control" placeholder = "Введите email ..." required>
                <br>
            ...
            <table class="table">
                <?php
                    $r = $conn -> query("SELECT * FROM kursWe ORDER BY id DESC");
                    $n = mysqli_num_rows($r);
                    if ($n) {
                        echo '
                        <tr>
                        ...
                        do {
                            echo '
                                <tr>
                                    ...
                                    <td class="text-center"><a href = "./php/about.php?id='.$row["id"].'"><button type="button" class=" btn-success" style="padding:5px 10px; font-size:25px"><i class="fas fa-pen"></i></button></a></td>
    ...
    <script>
        document.querySelector(".biz").style.borderBottom = "2px solid green";
